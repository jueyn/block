...
wget -N https://raw.githubusercontent.com/jekya/block/master/blacklist-ips/blacklist-ips.txt
cat blacklist-ips.txt dnscrypt-blacklist-ips.txt | sort | uniq > blocked-ips.txt
sed -e 's/$/\r/' blocked-ips.txt > blocked-ips1.txt
wget -N https://raw.githubusercontent.com/jekya/block/master/blacklist-ips/rebinding-protection.txt
cat rebinding-protection.txt blocked-ips1.txt > blocked-ipss.txt
mv blocked-ipss.txt blocked-ips.txt

wget -N https://raw.githubusercontent.com/jekya/block/master/cloaking-rules/cloaking-rule.txt
